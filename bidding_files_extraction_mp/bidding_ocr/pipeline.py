...
def _process_pdf_worker(task: tuple[Path, Path, Path, ProcessingConfig, str]) -> tuple[ParsedDocument, list[str]]:
    """
...
def process_pdf_tree(
    ...
    if workers == 1:
        ...
        indexed_results: dict[int, tuple[tuple[ParsedDocument, list[str]] | None, Exception | None]] = {}
